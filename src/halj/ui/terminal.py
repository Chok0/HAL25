...
from ..generative.conversation import Conversation
...
class TerminalDisplay:
    ...
    def render(
        ...
        line = self.format_line(frame, scheduler, harmony, conversation)
    ...
    def format_line(
        ...
        if conversation is not None:
            # A qui est le tour : dans une jam, c'est la question qu'on se pose
            # en permanence et qu'on ne tranche jamais tout a fait.
            parts.append(f"main {'appli' if conversation.leads else 'vous '}")
